 ...
 * 此种方式似乎并不需要使用 @Configuration 注解，好像 @OpenAPIDefinition 注解就足够让 SpringDoc 获取到配置了。
...
//    info = @Info(
//        title = "Swagger3.0 (OpenAPI) 框架 - From Annotation",              // Api接口文档标题（必填）
...
//    servers = {
//        @Server(url = "http://localhost:8100/demo/", description = "本地服务")
//    },
//    // 外部文档信息
//    externalDocs = @ExternalDocumentation(description = "更多内容请查看该链接", url = "https://external.doc.example.com/")
//)
