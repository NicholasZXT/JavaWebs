        ...
        GroupedOpenApi groupedOpenApi = GroupedOpenApi.builder()
                ...
                .addOpenApiCustomiser(
                    openApi -> openApi.openapi("3.0.2")
                        .info(new Info().title("Title of GroupedOpenApiForG1"))
                )
                // 设置此分组接口要扫描的package
                ...
                //.consumesToMatch("*/*")
                // API返回的消息格式，需要保证接口的返回消息格式与上面配置的consumesToMatch()方法中指定的格式一致
        ...
        GroupedOpenApi groupedOpenApi = GroupedOpenApi.builder()
                ...
                .addOpenApiCustomiser(
                    openApi -> openApi.openapi("3.0.3")
                        .info(new Info().title("Title of GroupedOpenApiForG2"))
                )
                .packagesToScan("pers.zxt.springboot.ssm.controller")
                //.packagesToExclude("")
