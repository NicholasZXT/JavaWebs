package pers.zxt.spring.aop.service.impl;

import pers.zxt.spring.aop.service.SomeService;

/**
 * 此 Service 的接口实现类中，每个方法内部只有业务逻辑代码，非业务逻辑的代码，交给了代理类 ServiceProxy 实现
 */
public class SomeServiceAopImpl implements SomeService {
