package pers.spring.aop.handler;
...
public class MyAspect {
    ...
    /**
     ...
     特点：
      ...
      3）不会修改目标方法的执行结果。
     */
    @Before(value = "execution(public void pers.spring.aop.service.impl.SomeServiceImplV2.doSome(String, int))")
    ...
    @Before(value = "execution(public void pers.spring.aop.service.impl.SomeServiceImplV2.do*(String, int))")
